...
function AnalyticsContent() {
  ...
  const SECTION_KEYS = ['trafficOverview', 'applicationActivity', 'conversionFunnel', 'sourceBreakdown', 'salary', 'demographics', 'bestTime', 'benchmarking', 'qualityScore', 'costPerHire', 'descPerformance', 'retentionFunnel', 'jobPerformance', 'topConverting', 'recentActivity'] as const
  const DEFAULT_EXPANDED = ['trafficOverview', 'applicationActivity']
  const [collapsedSections, setCollapsedSections] = useState<Record<string, boolean>>(() => {
    const defaults: Record<string, boolean> = {}
    SECTION_KEYS.forEach(key => { defaults[key] = !DEFAULT_EXPANDED.includes(key) })
    return defaults
  })

  useEffect(() => {
    try {
      const saved = localStorage.getItem('analytics_collapsed_sections')
  ...
  const toggleSection = useCallback((key: string) => {
    setCollapsedSections(prev => {
      ...
      try { localStorage.setItem('analytics_collapsed_sections', JSON.stringify(next)) } catch {}
      return next
    })
  }, [])
  ...
  const toggleAllSections = useCallback(() => {
    setCollapsedSections(prev => {
      const anyCollapsed = Object.values(prev).some(v => v)
      const next: Record<string, boolean> = {}
      SECTION_KEYS.forEach(key => { next[key] = !anyCollapsed })
      try { localStorage.setItem('analytics_collapsed_sections', JSON.stringify(next)) } catch {}
      return next
    })
  }, [])

  const renderChevron = (sectionKey: string) => (
    <svg
      className={`${styles.chevron} ${!collapsedSections[sectionKey] ? styles.chevronExpanded : ''}`}
  ...
  return (
    <main className={styles.page}>
      <Header />
      <TrialStatusBanner userType="employer" />
      ...
      <div className={`${styles.container} ${!isProfessional ? styles.blurredContent : ''}`}>
        ...
        {/* Traffic Overview + Application Activity — side by side */}
        <div className={styles.twoColGridEqual} style={{ marginBottom: '1.5rem' }}>
          {/* Traffic Overview */}
          <div className={`${styles.sectionCard} ${collapsedSections.trafficOverview ? styles.sectionCardCollapsed : ''}`}>
            <div className={styles.collapsibleHeader} onClick={() => toggleSection('trafficOverview')}>
              ...
              {renderChevron('trafficOverview')}
            </div>
            <div className={`${styles.collapsibleContent} ${collapsedSections.trafficOverview ? styles.collapsed : ''}`}>
          ...
          <div className={`${styles.sectionCard} ${collapsedSections.applicationActivity ? styles.sectionCardCollapsed : ''}`}>
            <div className={styles.collapsibleHeader} onClick={() => toggleSection('applicationActivity')}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              {renderChevron('applicationActivity')}
            </div>
            <div className={`${styles.collapsibleContent} ${collapsedSections.applicationActivity ? styles.collapsed : ''}`}>
              <div className={styles.collapsibleInner}>
                <div className={styles.chartHeader} style={{ marginTop: '0.75rem' }}>
                  <div />
                  <select
        ...
        {/* Conversion Funnel */}
        <div className={`${styles.sectionCard} ${collapsedSections.conversionFunnel ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('conversionFunnel')}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            {renderChevron('conversionFunnel')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.conversionFunnel ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner} style={{ paddingTop: '0.75rem' }}>
              {maxFunnelValue > 1 ? (
        ...
        {mounted && conversionRateOverTimeData.length > 1 && (
        ...
        <div className={`${styles.sectionCard} ${collapsedSections.sourceBreakdown ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('sourceBreakdown')}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            {renderChevron('sourceBreakdown')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.sourceBreakdown ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
        ...
        {salaryInsights && (
          <div className={`${styles.sectionCard} ${collapsedSections.salary ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
            <div className={styles.collapsibleHeader} onClick={() => toggleSection('salary')}>
              <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Salary Insights</h2>
              {renderChevron('salary')}
            </div>
            <div className={`${styles.collapsibleContent} ${collapsedSections.salary ? styles.collapsed : ''}`}>
              <div className={styles.collapsibleInner}>
        ...
        {demographics && (
          <div className={`${styles.sectionCard} ${collapsedSections.demographics ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
            <div className={styles.collapsibleHeader} onClick={() => toggleSection('demographics')}>
              <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Candidate Demographics</h2>
              {renderChevron('demographics')}
            </div>
            <div className={`${styles.collapsibleContent} ${collapsedSections.demographics ? styles.collapsed : ''}`}>
              <div className={styles.collapsibleInner}>
        ...
        {!demographics && candidateProfiles.length === 0 && !loading && (
          <div className={`${styles.sectionCard} ${collapsedSections.demographics ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
            <div className={styles.collapsibleHeader} onClick={() => toggleSection('demographics')}>
              <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Candidate Demographics</h2>
              {renderChevron('demographics')}
        ...
        {/* Best Time to Post */}
        <div className={`${styles.sectionCard} ${collapsedSections.bestTime ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('bestTime')}>
            <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Best Time to Post</h2>
            {renderChevron('bestTime')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.bestTime ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
        ...
        {/* Market Benchmarking */}
        <div className={`${styles.sectionCard} ${collapsedSections.benchmarking ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('benchmarking')}>
            <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Market Benchmarking</h2>
            {renderChevron('benchmarking')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.benchmarking ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
        ...
        {/* Application Quality Score */}
        <div className={`${styles.sectionCard} ${collapsedSections.qualityScore ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('qualityScore')}>
            <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Application Quality Score</h2>
            {renderChevron('qualityScore')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.qualityScore ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
          {applicationQuality ? (
            <>
        ...
        {/* Cost Per Hire */}
        {costPerHire && (
          <div className={`${styles.sectionCard} ${collapsedSections.costPerHire ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
            <div className={styles.collapsibleHeader} onClick={() => toggleSection('costPerHire')}>
              <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Cost Per Hire</h2>
              {renderChevron('costPerHire')}
            </div>
            <div className={`${styles.collapsibleContent} ${collapsedSections.costPerHire ? styles.collapsed : ''}`}>
              <div className={styles.collapsibleInner}>
        ...
        {/* Job Description Performance */}
        <div className={`${styles.sectionCard} ${collapsedSections.descPerformance ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('descPerformance')}>
            <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Job Description Performance</h2>
            {renderChevron('descPerformance')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.descPerformance ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
        ...
        {/* Retention Funnel */}
        <div className={`${styles.sectionCard} ${collapsedSections.retentionFunnel ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('retentionFunnel')}>
            <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Retention Funnel</h2>
            {renderChevron('retentionFunnel')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.retentionFunnel ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
        ...
        <div className={`${styles.sectionCard} ${collapsedSections.jobPerformance ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('jobPerformance')}>
            <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Job Performance</h2>
            {renderChevron('jobPerformance')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.jobPerformance ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
        ...
        {/* Top Converting Jobs */}
        <div className={`${styles.sectionCard} ${collapsedSections.topConverting ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('topConverting')}>
            <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Top Converting Jobs</h2>
            {renderChevron('topConverting')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.topConverting ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
        ...
        {/* Recent Activity */}
        <div className={`${styles.sectionCard} ${collapsedSections.recentActivity ? styles.sectionCardCollapsed : ''}`} style={{ marginBottom: '1.5rem' }}>
          <div className={styles.collapsibleHeader} onClick={() => toggleSection('recentActivity')}>
            <h2 className={styles.sectionTitle} style={{ margin: 0 }}>Recent Activity</h2>
            {renderChevron('recentActivity')}
          </div>
          <div className={`${styles.collapsibleContent} ${collapsedSections.recentActivity ? styles.collapsed : ''}`}>
            <div className={styles.collapsibleInner}>
